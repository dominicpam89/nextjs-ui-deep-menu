export const menuMock1: TypeMenu[] = [
   {
...
export const menuMock2: TypeMenu[] = [
   {
      menuId: "asdqw98e76123",
      depth: 0,
      name: "systemmanagement",
